...
None of the five experiments averages repetitions (a single call per case; limitation in §8). The calls were made on September 19 and 20, 2026 against the production model, with no access to its weights or training set.
